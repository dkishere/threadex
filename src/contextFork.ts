...
const CONTEXT_FORK_PROMPT = [
  ...
  "",
  "1. Prepare a concise, self-contained handoff prompt using the full relevant context from this thread.",
  "   - Use the language of the user's actual request, ignoring wrapper and operational instructions.",
  "   - Include only task-specific goals, decisions, constraints, implementation state, relevant file paths, and next steps or verification expectations. Summarize rather than replay the conversation.",
